...
<div class="container">
  <div class="card kartu" style="width: 80%;">
    <div class="row">
      ...
      <div class="foto">
        <img src="img/foto/foto_8.png" alt="" width="200" height="auto">
      </div>
      </div>
          ...
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: rgb(118, 157, 29); font-weight:bold; font-size: 24px;" class="underline-hover-effect">Heru Prasetyo Adi, S.Pd</td>
            </tr>
          <tr>
              <td class="textt">Jenis Kelamin</td>
                <td>:</td>
                <td class="underline-hover-effect">Laki-Laki</td>
            </tr>
          <tr>
              <td class="textt">Tempat/Tgl.lahir</td>
                <td>:</td>
                <td class="underline-hover-effect">Malang, 05-10-2976</td>
            </tr>
          <tr>
              <td class="textt">Pangkat/Gol/Ruang</td>
                <td>:</td>
                <td class="underline-hover-effect">Penata Tk.1 III/ d</td>
            </tr>
          <tr>
              <td class="textt">Jabatan</td>
                <td>:</td>
                <td class="underline-hover-effect">Petugas Pengadministrasian</td>
            </tr>
          <tr>
            ...
            <tr>
              <td valign="top" class="textt">Alamat</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">Batu Belek Barat Kel. Rakam Kec. Selong</td>
            </tr>
            <tr>
              <td valign="top" class="textt">NIP</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">197610052005011003</td>
            </tr>
    ...
    <div class="tupoksi text-center">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        "Melaksanakan tugas administrasi,  melaksanakan kegiatan pengelolaan kearsipan serta melaporkan pelaksanaan tugas kepada Kepala Kantor Urusan Agama Kecamatan Selong"
      </p>
    ...
    <div class="tugas">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        <ol style="position: relative; bottom: 50px;">
          ...
          <li>
            Melayani kebutuhan pimpinan/atasan yang berkaitan dengan tugas kantor 
          </li>
          ...
          <li>
             Mengisi buku penerimaan biaya nikah
          </li>
          <br>

          <li>
             Melaksanakan tugas yang berkaitan dengan surat masuk dan keluar
          </li>
          <br>
          ...
          <li>
             Merekap data nikah dipapan data
          </li>
          <br>

          <li>
             Merekap data jumlah penduduk dan lain lain
          </li>
          <br>

          <li>
             Verifikasi berkas Catin
          </li>
          <br>

          <li>
             Melayani kebutuhan masyarakat yang berkaitan dengan surat menyurut dan legalisir
          </li>
          <br>
          ...
          <li>
             Memelihara dan menganalisis kebutuhan sarana ditiap-tiap ruangan
          </li>
          <br>
          ...
          <li>
             Melaksanakan dan menganalisis kebutuhan sarana ditiap-tiap ruangan
          </li>
          <br>

          <li>
             pendistribusin blangko NR
          </li>
          <br>
