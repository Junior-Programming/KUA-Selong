...
<div class="container">
  <div class="card kartu" style="width: 80%;">
    <div class="row">
      ...
      <div class="foto">
        <img src="img/foto/foto_6.png" alt="" width="200" height="auto">
      </div>
      </div>
        ...
        <table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: rgb(118, 157, 29); font-weight:bold; font-size: 24px;" class="underline-hover-effect">Darsiah, S.Hi</td>
            </tr>
          <tr>
          ...
          <tr>
              <td class="textt">Tempat/Tgl.lahir</td>
                <td>:</td>
                <td class="underline-hover-effect">Bungtiang, 02-07-1982</td>
            </tr>
          <tr>
          ...
          <tr>
              <td class="textt">Jabatan</td>
                <td>:</td>
                <td class="underline-hover-effect">Penghulu Muda</td>
            </tr>
          <tr>
              <td valign="top" class="textt">Pendidikan</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">S1</td>
            </tr>
            <tr>
              <td valign="top" class="textt">Alamat</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">Pringga Jurang, Kec.Montong Gading</td>
            </tr>
            <tr>
              <td valign="top" class="textt">NIP</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">198207022011011007</td>
            </tr>
    ...
    <div class="tupoksi text-center">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        "Melaksanakan tugas dan jabatan Fungsional sebagai penghulu muda pasa KUA Kecamatan Selong"
      </p>
    ...
    <div class="tugas">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        <ol style="position: relative; bottom: 50px;">
          <li>
             Melaksanakan / Pengawasan pernikahan dan rujuk pada Kua Kec.Selong 
          </li>

          <br>

          <li>
            Melakukan kegiatan penolakan kehendak Nikah dan rujuk Melakukan kegiatan pembinaan terhadap calon pengantin 
          </li>

          <br>

          <li>
            Melakukan kegiatan Pelayanan akad Nikah atau Rujuk terhadap Warga Negara Indonesia 
          </li>

          <br>

          <li>
            Melakukan kegiatan Khutbah/Nasehat Nikah Rujuk dengan Bahasa Daerah / Indonesia 
          </li>
          ...
          <li>
            Melakukan kegiatan pendampingan /penaganan potensi komplik 
          </li>

          <br>

          <li>
            social keagamaan dengan tingkat resiko 
          </li>
