  ...
  <body>
    ...
    <div class="container p-3">
      ...
      <button type="button" class="btn btn-success">
        <b>1. PRODUKTIVITAS DALAM PENCAPAIYAN TERGER PELAYANAN</b>
      </button>
      <!-- EndButton_1 -->
      ...
      <p style="position: relative; top: -16px; font-family: Agency FB; font-size: 25px;">
        &emsp; &emsp; &emsp; Kantor urusan agama kecamatan Selong sebagai salah satu unit kerja pemerintah yang menangani bidang keagamaan diharuskan untuk menetapkan target kinerja pelayanan dan membuat tingkat capaian kinerja sebagai bahan evaluasi dan untuk mengukur tingkat pencapaian dan produktifitas dalam mencapai hasil pelaksanaan dari program-program atau bentuk-bentuk pelayanan yang ada di kantor urusan agama. Penetapan target kinerja pelayanan dan tingkat pencapaian kinerja kami sajikan dalam lampiran.
      </p>
      ...
      <p style="position: relative; top: -16px; font-family: Agency FB; font-size: 25px;">
        &emsp; &emsp; &emsp; Sebagai bagian tak terpisahkan dengan tugas pokok dan fungsi Kementerian Agama, maka tujuan kebijakan operasional Kantor Urusan Agama Kecamatan Selong adalah menindak lanjutiapa yang menjadi kebijakan Kementerian Agama, yakni terwujudnya pelayanan prima kepada masyarakat terkait dengan nikah dan rujuk, keluarga sakinah zakat, wakaf dan kemasjidan serta meningkatkan pelaksanaan kehidupan beragama dan kerukunan antar umat beragama.
      </p>
      ...
      <hr class="mb-4" style="position: relative; top: -16px; left: 5px;">
       ...
       <p style="position: relative; top: -16px; font-family: Agency FB; font-size: 25px;">
        &emsp; &emsp; &emsp; Agar pelaksanaan tugas berjalan sesuai dengan standar yang diharapkan, maka harus senantiasa bertahap dan berkesinambungan serta dengan mudah dapat dipantau dan dievaluasi untuk menjadi bahan dan pedoman dalam perencanaan pelaksanaan tugas yang akan datang, maka disusunlah program kerja tahunan.
      </p>
      <p style="position: relative; top: -16px; font-family: Agency FB; font-size: 25px;">
        &emsp; &emsp; &emsp; Oleh karena KUA Kecamatan Selong merupakan perpanjangan tangan dari Seksi
        Bimas Islam, maka program kerja bersifat menjabarkan program seksi Bimas Islam ditambah sektor terkait yang disesuaikan dengan situasi dan kondisi Program kerja KUA Kecamatan Selong di buat tiap awal tahun anggaran sebagai bahan penyusunan program kerja tahun anggaran 2017/2018 sebagimana terlampir
      </p>
    </div>
    <!-- EndFigure -->
