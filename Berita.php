...
<html lang="en">
  ...
  <body>
   ...
   <!-- Carosuel -->
       <div class="container p-3" style="position: relative; left: 35px;">
         <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="height :30%;">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="img/slide4.jpeg" class="d-block h-100" alt="..." style="border: 5px solid green; padding: 3px;">
          <div class="carousel-caption d-none d-md-block">
            <h5>Piloting Pusaka Sakinah 2021</h5>
            <p>Berkah Relasi harmonis Kantor urusan Agama Kecamatan Selong</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="img/slide5.jpeg" class="d-block h-100" alt="..." style="border: 5px solid green; padding: 3px;">
          <div class="carousel-caption d-none d-md-block">
            <h5>Pengukuhan Pengurus (LPTQ)</h5>
            <p>Rapat kerja kecamatan Pengurus LPTQ Kecamatan SELONG</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="img/slide7.jpeg" class="d-block h-100" alt="..." style="border: 5px solid green; padding: 3px;">
          <div class="carousel-caption d-none d-md-block">
            <h5>Piloting Pusaka Sakinah 2021</h5>
            <p>Berkah Relasi harmonis Kantor urusan Agama Kecamatan Selong</p>
          </div>
   ...
   <div class="media">
     ...
     <div class="card shadow p-3 mb-5 bg-body rounded" style="width: 18rem;">
      <img src="img/copy - slide6.jpeg" class="card-img-top" alt="Berita_1">
      <div class="card-body">
   ...
   <!-- Button -->
   <div class="container">
   <button type="button" class="btn btn-secondary">Populer News</button>
   ...
   <div class="container">
     <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="img/Berita_1.png" class="d-block w-100" alt="Berita_1" style="border: 5px solid green; padding: 3px;">>
          <div class="carousel-caption d-none d-md-block">
            <h5><a href="https://bit.ly/3rN8IEi" target="_blank" style="text-decoration: none; Color: white;">Menag Sebut Disiplin Prokes sebagai Kelemahan Virus</a></h5>
            <p>
              Menteri Agama Saat Memberikan Sambutan Pada Acara Silaturahmi Menko Polhukan, BNPB, Gubernur Jateng dan Pemuka Agama Se-Jateng
            </p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="img/berita_2.png" class="d-block w-100" alt="berita_2" style="border: 5px solid green; padding: 3px;">>
          <div class="carousel-caption d-none d-md-block">
            <h5><a href="https://bit.ly/3CblYr2" target="_blank" style="text-decoration: none; Color: white;">Kemenag Proses Pencairan 3,668 T BOS Madrasah Tahap II 2021</a></h5>
            <p>Menag Yaqut Cholil Qoumas</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="img/berita_3.png" class="d-block w-100" alt="berita_3" style="border: 5px solid green; padding: 3px;">
          <div class="carousel-caption d-none d-md-block">
            <h5><a href="https://bit.ly/3CblYr2" target="_blank" style="text-decoration: none; Color: white;">Bantu Penanganan Pandemi, Kemenag Realokasi Hampir Rp2 Triliun Anggaran 2021</a></h5>
            <p>Menag Yaqut Cholil Qoumas</p>
          </div>
        </div>
      </div>
