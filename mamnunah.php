  ...
  <div class="card kartu" style="width: 80%;">
        ...
        <table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: rgb(118, 157, 29); font-weight:bold; font-size: 24px" class="underline-hover-effect">Mamnunnah</td>
            </tr>
          <tr>
          ...
          <tr>
              <td class="textt">Tempat/Tgl.lahir</td>
                <td>:</td>
                <td class="underline-hover-effect">Pancor, 31-12-1965</td>
            </tr>
          <tr>
              <td class="textt">Pangkat/Gol/Ruang</td>
                <td>:</td>
                <td class="underline-hover-effect">Penata muda Tk.1 III/b</td>
            </tr>
          <tr>
              <td class="textt">Jabatan</td>
                <td>:</td>
                <td class="underline-hover-effect">Bendahara Pengeluaran Pembantu</td>
            </tr>
          <tr>
              <td valign="top" class="textt">Pendidikan</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">MAN/SLTA</td>
            </tr>
            <tr>
              <td valign="top" class="textt">Alamat</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">Pancor Lauk masjid, Kel.Pancor, Kec.Selong</td>
            </tr>
            <tr>
              <td valign="top" class="textt">NIP</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">196512311993032006</td>
            </tr>
    ...
    <div class="tupoksi text-center">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        "Melaksanakan tugas dan jabatan sebagai Pelaksana Bendahara Pengeluaran Pembantu pada KUA Kecamatan Selong"
      </p>
    ...
    <div class="tugas">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        <ol style="position: relative; bottom: 50px;">
          <li>
             Menerbitkan Billing Simponi
          </li>

          <br>

          <li>
            Menerima dan Mencatat Pendaftaran NR pada Buku Kas NR
          </li>

          <br>

          <li>
            Mengetik surat tugas PPN dan Penghulu untuk pernikahan diluar KUA
          </li>

          <br>

          <li>
            Membuat Lpaoran / Menulis Laporan Keuangan NR 
          </li>

          <br>

          <li>
            Mengirim laporan - laporan keuangan KUA 
          </li>
          ...
          <li>
            Belanja Barang untuk Keperluan Kantor
          </li>

          <br>

          <li>
            Melaksanakan tugas - tugas lain yang diberikan oleh Pemimpin
          </li>
        </ol>
      </p>
