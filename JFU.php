...
<div class="container">
  <div class="card kartu" style="width: 80%;">
    <div class="row">
      ...
      <div class="foto">
        <img src="img/foto/foto_5.png" alt="" width="200" height="auto">
      </div>
      </div>
        ...
        <table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: rgb(118, 157, 29); font-weight:bold; font-size: 24px;" class="underline-hover-effect">Saipul Haq</td>
            </tr>
          <tr>
          ...
          <tr>
              <td class="textt">Tempat/Tgl.lahir</td>
                <td>:</td>
                <td class="underline-hover-effect">Pancor, 20-04-1969</td>
            </tr>
          <tr>
              <td class="textt">Pangkat/Gol/Ruang</td>
                <td>:</td>
                <td class="underline-hover-effect">III/b</td>
            </tr>
          <tr>
              <td class="textt">Jabatan</td>
                <td>:</td>
                <td class="underline-hover-effect">JFU</td>
            </tr>
          <tr>
              <td valign="top" class="textt">Pendidikan</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">D.II</td>
            </tr>
            <tr>
              <td valign="top" class="textt">Alamat</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">Gubuk Lauk Pancor, Kec.Selong</td>
            </tr>
            <tr>
              <td valign="top" class="textt">NIP</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">196904201991031005</td>
            </tr>
    ...
    <div class="tupoksi text-center">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        "Melaksanakan tugas dan jabatan sebagai pelaksana ketatausahaan dan Kerumahtanggaan KUA Kecamatan Selong"
      </p>
    ...
    <div class="tugas">
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        <ol style="position: relative; bottom: 50px;">
          ...
          <li>
            Membuat daftar pentelaahan arsif 
          </li>

          <br>

          <li>
            Melayani legalisir (kutipan akta nikah)
          </li>

          <br>

          <li>
            Melengkapi dan mengarsipkan dokumen pegawai 
          </li>

          <br>

          <li>
            Melengkapi dan menyiapkan permohonan blanko NA  
          </li>

          <br>

          <li>
            Melayani persyaratan dispensasi Camat 
          </li>

          <br>

          <li>
            Melayani tamu dan mengisi bukunya 
          </li>

          <br>

          <li>
            Membuat SABMN Membuat laporan kegiatan kerja kepala KUA 
          </li>
